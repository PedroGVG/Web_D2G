...
function Use-RootRelativeAssets {
    ...
    $Html = $Html.Replace('data-src-es="assets/', 'data-src-es="/assets/')
    $Html = $Html.Replace('data-src-en="assets/', 'data-src-en="/assets/')
    $Html = $Html.Replace('data-srcset-es="assets/', 'data-srcset-es="/assets/')
    $Html = $Html.Replace('data-srcset-en="assets/', 'data-srcset-en="/assets/')
